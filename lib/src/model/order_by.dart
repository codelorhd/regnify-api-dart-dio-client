...
class OrderBy extends EnumClass {
  ...
  /// An enumeration.
  @BuiltValueEnumConst(wireName: r'DATE_CREATED')
  static const OrderBy CREATED = _$CREATED;
  /// An enumeration.
  @BuiltValueEnumConst(wireName: r'DATE_MODIFIED')
  static const OrderBy MODIFIED = _$MODIFIED;
