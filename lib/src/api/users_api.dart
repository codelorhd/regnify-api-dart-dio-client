...
class UsersApi {
  ...
  Future<Response<UserOut>> adminChangeUserPassword({ 
    ...
    final _path = r'/users/{user_id}/admin-change-user-password'.replaceAll('{' r'user_id' '}', userId.toString());
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<AppResponseModel>> changeUserPassword({ 
    required ChangePasswordWithToken changePasswordWithToken,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/change-user-password';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ChangePasswordWithToken);
      _bodyData = _serializers.serialize(changePasswordWithToken, specifiedType: _type);
  ...
  /// Parameters:
  /// * [userCreate] 
  /// * [adminSignupToken] - The correct admin token to use admin only features
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [UserOut] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UserOut>> createUser({ 
    ...
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        if (adminSignupToken != null) r'admin-signup-token': adminSignupToken,
        ...?headers,
      },
      extra: <String, dynamic>{
        'secure': <Map<String, String>>[
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ManySystemScopeOut] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ManySystemScopeOut>> listScopes({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/list-scopes';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ManySystemScopeOut _responseData;

    try {
      const _responseType = FullType(ManySystemScopeOut);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as ManySystemScopeOut;
    ...
    return Response<ManySystemScopeOut>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [UserOut] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UserOut>> readUser({ 
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [UserOut] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UserOut>> readUserMe({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ManyUsersInDB] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ManyUsersInDB>> readUsers({ 
    String? query,
    int? skip = 0,
    int? limit = 100,
    CancelToken? cancelToken,
    ...
    ManyUsersInDB _responseData;

    try {
      const _responseType = FullType(ManyUsersInDB);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as ManyUsersInDB;
  ...
  /// Returns a [Future] containing a [Response] with a [AppResponseModel] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<AppResponseModel>> requestPasswordChange({ 
    ...
    final _path = r'/users/request-password-change';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [AppResponseModel] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<AppResponseModel>> resendInvite({ 
    required String email,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/users/resend-invite';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [UserOut] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UserOut>> updateUser({ 
    required String userId,
